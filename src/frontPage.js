                ...
                <div className="navDiv"  style={{marginBottom: '50px'}}>
                    <nav className="navBar">
                        <nav style={{textAlign:'left', marginBottom: '-30px',marginTop: '15px', marginLeft: '20px'}} className="linkButtons">
                            <a className="navIcon"><img src={insta} alt="" style={{width:'13px'}} /> </a>
                            <a className="navIcon"><img src={facebook} alt="" style={{width:'13px'}}  /> </a>
                            <a className="navIcon"><img src={twitter} alt="" style={{width:'13px'}} /> </a>
                            <a className="navIcon"><img src={pinterest} alt="" style={{width:'13px'}} /> </a>
                        </nav>
